...
export const createDiaryEntry = createAsyncThunk(
    "diary/createEntry",
    async (payload) => {
        const res = await axios.post("https://appointment-tracker-backend-3.onrender.com/diary", payload);
        return res.data;
    }
);
...
export const fetchDiaryEntries = createAsyncThunk(
    "diary/fetchEntries",
    async () => {
        const res = await axios.get("https://appointment-tracker-backend-3.onrender.com/diary");
        return res.data;
    }
);
...
export const updateDiaryEntry = createAsyncThunk(
    "diary/updateEntry",
    async ({ id, data }) => {
        const res = await axios.put(`https://appointment-tracker-backend-3.onrender.com/diary/${id}`, data);
        return res.data;
    }
);
...
export const deleteDiaryEntry = createAsyncThunk(
    "diary/deleteEntry",
    async (id) => {
        await axios.delete(`https://appointment-tracker-backend-3.onrender.com/diary/${id}`);
        return id;
    }
);
...
export const searchDiaryEntries = createAsyncThunk(
    "diary/searchEntries",
    async (query) => {
        const res = await axios.get(`https://appointment-tracker-backend-3.onrender.com/diary/search?q=${query}`);
        return res.data;
    }
);
...
export const filterEntriesByMood = createAsyncThunk(
    "diary/filterByMood",
    async (mood) => {
        const res = await axios.get(`https://appointment-tracker-backend-3.onrender.com/diary/filter/mood?mood=${mood}`);
        return res.data;
    }
);
...
export const filterEntriesByDateRange = createAsyncThunk(
    ...
    async ({ startDate, endDate }) => {
        const res = await axios.get(`https://appointment-tracker-backend-3.onrender.com/diary/filter/date?startDate=${startDate}&endDate=${endDate}`);
        return res.data;
    }
);
...
export const getEntriesOnThisDay = createAsyncThunk(
    "diary/getOnThisDay",
    async () => {
        const res = await axios.get("https://appointment-tracker-backend-3.onrender.com/diary/onthisday");
        return res.data;
    }
);
